...
final List<Project> projects = [
  ...
  dateLaunched: 'May 2020', googlePlayStoreLink: 'https://play.google.com/store/apps/details?id=dev.ashtonjones.reply', projectGIFResource: 'images/reply.gif', technologiesUsed: ['java', 'androidsdk', 'android architecture components', 'firebase authentication', 'cloud firestore', 'mvvm architecture', 'material design']),
  Project(
      title: 'Torch',
  ...
  googlePlayStoreLink: 'https://play.google.com/store/apps/details?id=dev.ashtonjones.torch', projectGIFResource: 'images/torchdemo.gif', technologiesUsed: ['java', 'androidsdk', 'android architecture components', 'firebase authentication', 'cloud firestore', 'mvvm architecture', 'material design']),
];