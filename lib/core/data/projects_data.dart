...
final List<Project> projects = [
  Project(
    ...
    shortDescription:
        'A Flutter app containing an RSS feed of my Medium articles',
    longDescription:
        'I decided to experiment with Medium\'s RSS feed, because it would make creating an MVP for a Flutter app I am working on effortless. I learned how to access data from an RSS feed, parse RSS feed data, and extract data from a feed and display it in an application',
  ...
  Project(
      ...
      longDescription:
          'I built my portfolio website using Flutter for Web. I learned how to build for the Web using Flutter, make UI elements flexible to adapt to different screen sizes, resize images and provide consistent dimensions, and implement complex Flare animations. You can find the project here',
  ...
  Project(
      ...
      projectGIFResource: 'images/_replyDemo.gif',
      platforms: ['android, ios'],
      technologiesUsed: [
        'flutter',
        'dart',
  ...
  Project(
      ...
      githubLink: 'https://github.com/ashtonjonesdev/Reply',
      projectGIFResource: 'images/reply.gif',
      technologiesUsed: [
        'java',
        'androidsdk',
